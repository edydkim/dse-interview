...
-- Stored Procedure
CREATE OR REPLACE PROCEDURE cron_credit_score_data(in csv_path text)
    LANGUAGE plpgsql
AS
$$
DECLARE
...
CALL cron_credit_score_data('/Users/eddie/Documents/dse-interview/data/cleanup_sample_data.csv');